...
- fix width of library container

### Other Changes

- Merge pull request #80 from cardner/max-width
...
- update deployment script to have git creds
...
- Merge pull request #71 from cardner/fix-deployment-script
